...
public class DemandsAdapter extends BaseAdapter {
    ...
    /* List to adapt */
    private List<Object> demands;

    /* context */
    private Context context;


    public DemandsAdapter(Context context, List<Object> demands,DaoFactory daoFactory) {
        super();
    ...
    public Object getItem(int position) {
        return this.demands.get(position);
    }
    ...
    public int getItemViewType(int position) {
        if (this.demands.get(position) instanceof String)
            return ITEM_VIEW_TYPE_CATEGORY;
        else if (this.demands.get(position) instanceof DemandsModel.Title)
    ...
    public View getView(final int position, View convertView,final ViewGroup parent) {
        ...
        if (type == ITEM_VIEW_TYPE_MAIN) {
            ...
            viewHolder.code.setText(String.valueOf(((DemandsModel.Title) getItem(position)).getCode()));
            viewHolder.title.setText(String.valueOf(((DemandsModel.Title) getItem(position)).getTitle()));
            ...
            viewHolder.member.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    SupplyDemandBean supplyDemandBean = daoFactory.getSupplyDemandDao().getSupplyDemand(((DemandsModel.Title) getItem(position)).getCode());
