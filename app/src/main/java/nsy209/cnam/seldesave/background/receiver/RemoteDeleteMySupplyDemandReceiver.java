...
public class RemoteDeleteMySupplyDemandReceiver extends ResultReceiver {
    ...
    public RemoteDeleteMySupplyDemandReceiver(Handler handler, Activity activity, DaoFactory daoFactory) {
        super(handler);
