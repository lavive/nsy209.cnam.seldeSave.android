...
public class RemoteUpdateMySupplyDemandReceiver extends ResultReceiver {
    ...
    public RemoteUpdateMySupplyDemandReceiver(Handler handler, Activity activity, DaoFactory daoFactory) {
        super(handler);
